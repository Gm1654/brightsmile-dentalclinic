# BrightSmile Voice Assistant

I want to create a BrightSmile website for dental clinic plz add a voice agent:
# Deploy ElevenLabs Conversational AI Agent

Agent name: Voice agent
Agent ID: agent_7101kyyj9stjefjan2e9m0tzvsh6
...
function Agent() {
  ...
  const startConversation = async () => {
    ...
    await conversation.startSession({
      agentId: "agent_7101kyyj9stjefjan2e9m0tzvsh6",
...
function ConversationScreen() {
  ...
  const start = async () => {
    await conversation.startSession({ agentId: "agent_7101kyyj9stjefjan2e9m0tzvsh6" });
  };
...
function App() {
  return <elevenlabs-convai agent-id="agent_7101kyyj9stjefjan2e9m0tzvsh6"></elevenlabs-convai>;
}

Or use the CDN directly in HTML:

<script src="https://elevenlabs.io/convai-widget/index.js" async></script>
<elevenlabs-convai agent-id="agent_7101kyyj9stjefjan2e9m0tzvsh6"></elevenlabs-convai>
...
conversation = Conversation(
    client,
    agent_id="agent_7101kyyj9stjefjan2e9m0tzvsh6",
    requires_auth=False,
...
Endpoint: wss://api.elevenlabs.io/v1/convai/conversation?agent_id=agent_7101kyyj9stjefjan2e9m0tzvsh6

const ws = new WebSocket(
  "wss://api.elevenlabs.io/v1/convai/conversation?agent_id=agent_7101kyyj9stjefjan2e9m0tzvsh6"
);
...
const response = await fetch(
  `https://api.elevenlabs.io/v1/convai/conversation/token?agent_id=agent_7101kyyj9stjefjan2e9m0tzvsh6`,
...
**Live app**: https://brightsmile-dentalclinic.lovable.app

## Build with Lovable

Continue developing this project in the [Lovable editor](https://lovable.dev/projects/f0ab6ffa-2fda-4c6f-8676-c9a5478464ed).
